...
# has a blackjack (0), then the user wins. If the user_score is over 21, then the
# user loses. If the computer_score is over 21, then the computer loses. If none of
# the above, then the player with the highest score wins.
